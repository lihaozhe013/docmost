    ...
    >
      <div className={classes.toolbar}>
        ...
        <Tooltip position="top" label={t('Merge cells')}>
          <ActionIcon onClick={mergeCells} variant="subtle" size="lg" aria-label={t('Merge cells')}>
            <IconBoxMargin size={18} />
          </ActionIcon>
        </Tooltip>

        <Tooltip position="top" label={t('Split cell')}>
          <ActionIcon onClick={splitCell} variant="subtle" size="lg" aria-label={t('Split cell')}>
