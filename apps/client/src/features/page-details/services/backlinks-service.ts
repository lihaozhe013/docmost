...
export async function getBacklinksCount(pageId: string): Promise<IBacklinkCount> {
...
export async function getBacklinks(
  ...
  const req = await api.post<IPagination<IBacklinkPageItem>>('/pages/backlinks', params);
  return req.data;
}
