...
export class SpaceWatcherController {
  ...
  private async loadSpaceAndAuthorize(spaceId: string, user: User, workspace: Workspace) {
  ...
  @Post('watched-ids')
  async getWatchedSpaceIds(@AuthUser() user: User, @AuthWorkspace() workspace: Workspace) {
