...
export async function up(db: Kysely<any>): Promise<void> {
  await db.schema
    ...
    .addColumn('visibility', 'varchar', (col) => col.defaultTo(SpaceVisibility.PRIVATE).notNull())
    .addColumn('default_role', 'varchar', (col) => col.defaultTo(SpaceRole.WRITER).notNull())
    ...
    .addUniqueConstraint('spaces_slug_workspace_id_unique', ['slug', 'workspace_id'])
    .execute();
  ...
  await db.schema
    ...
    .addColumn('updated_at', 'timestamptz', (col) => col.notNull().defaultTo(sql`now()`))
    .addColumn('deleted_at', 'timestamptz', (col) => col)
    .addUniqueConstraint('space_members_space_id_user_id_unique', ['space_id', 'user_id'])
    .addUniqueConstraint('space_members_space_id_group_id_unique', ['space_id', 'group_id'])
    .addCheckConstraint(
