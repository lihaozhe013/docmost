...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  await db.schema.alterTable('users').addColumn('scim_external_id', 'text').execute();
  ...
  await db.schema.alterTable('groups').addColumn('scim_external_id', 'text').execute();
...
export async function down(db: Kysely<any>): Promise<void> {
  ...
  await db.schema.alterTable('workspaces').dropColumn('is_scim_enabled').execute();
}
