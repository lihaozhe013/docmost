...
const insertBlocksSchema = z.object({
  ...
  markdown: z
    ...
    .max(40_000)
    .describe(
      'Markdown for new supported paragraphs, headings, lists, task lists, quotes, callouts, tables, horizontal rules, fenced code blocks, Mermaid diagrams, and LaTeX formulas.'
    )
});
